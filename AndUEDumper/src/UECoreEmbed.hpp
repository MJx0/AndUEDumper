...
// Auto-embedded copies of source/UEProber/UECore/{Basic.h,Basic.cpp,UnrealContainers.h}.
// DumpSDK_UECoreStyle (Plan B) writes these out to SDK_B/ so the resulting
// output is self-contained — users no longer need to copy them by hand.
//
// Treat as binary — do not edit by hand. Refresh by re-running the generator
// snippet documented above DumpSDK_UECoreStyle in Dumper.cpp.
